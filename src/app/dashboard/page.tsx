...
export default function HomePage() {
  ...
  useEffect(() => {
    ...
    void fetchGenomes(); // Fixed: Added void operator
  }, []);
  ...
  useEffect(() => {
    ...
    if (selectedGenome) void fetchChromosomes(); // Fixed: Added void operator
  }, [selectedGenome]);
  ...
  useEffect(() => {
    ...
    void performGeneSearch( // Fixed: Added void operator
      selectedChromosome,
      selectedGenome,
  ...
  const handleSearch = async (e?: React.FormEvent) => {
    ...
    await performGeneSearch(searchQuery.trim(), selectedGenome); // Fixed: Added await
  };

  const loadBRCA1Example = () => {
    setMode("search");
    setSearchQuery("BRCA1");
    void performGeneSearch("BRCA1", selectedGenome); // Fixed: Added void operator
  };
